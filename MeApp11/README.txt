...
https://developer.android.com/studio Open Android Studio click the Tools tab and open the AVD Manager (Tools > AVD Manager).
...
Underneath ‘DEVELOPMENT APP’ once again, copy the ‘Key’ . In Android Studio, open the application’s code.
